    ...
    './node_modules/@storybook/components/dist/esm/tooltip/WithTooltip.js': (
          ...
          return (
            ...
            (_this.showTooltip = function (_ref) {
              ...
              _this.props.followCursor &&
                (state = _extends({}, state, { pageX, pageY })),
        ...
        return (
          ...
          (_proto.render = function render() {
            ...
            return react.createElement(
              ...
              this.getState() &&
                (usePortal
                  ? (0, react_dom.createPortal)(popper, portalContainer)
                  : popper)
            );
          }),
      ...
      function Tooltip_extends() {
        return (
          ...
          Tooltip_extends.apply(this, arguments)
        );
      }
      function _objectWithoutProperties(source, excluded) {
        ...
        var key,
          i,
          target = (function Tooltip_objectWithoutPropertiesLoose(
            source,
            excluded
          ) {
            if (null == source) return {};
      ...
      var _templateObject,
        ...
        Tooltip_Tooltip = function Tooltip(_ref5) {
          ...
          return react.createElement(
            Wrapper,
            Tooltip_extends({ hasChrome, placement, ref: tooltipRef }, props, {
              color,
            }),
            hasChrome &&
              react.createElement(
                Arrow,
                Tooltip_extends({ placement, ref: arrowRef }, arrowProps, {
                  color,
                })
              ),
            children
